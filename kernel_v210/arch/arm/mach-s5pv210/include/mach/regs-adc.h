...
/*
#define S3C_ADCCON0	   		S3C_ADCREG(0x00)
#define S3C_ADCCON	   		S3C_ADCREG(0x1000)
#define S3C_ADCTSC	  		S3C_ADCREG(0x1004)
#define S3C_ADCDLY	   		S3C_ADCREG(0x1008)
#define S3C_ADCDAT0	   		S3C_ADCREG(0x100C)
#define S3C_ADCDAT1	   		S3C_ADCREG(0x1010)
#define S3C_ADCUPDN			S3C_ADCREG(0x1014)
#define S3C_ADCCLRINT			S3C_ADCREG(0x1018)
#define S3C_ADCMUX			S3C_ADCREG(0x101C)
#define S3C_ADCCLRWK			S3C_ADCREG(0x1020)
*/
/* ADCCON Register Bits */
